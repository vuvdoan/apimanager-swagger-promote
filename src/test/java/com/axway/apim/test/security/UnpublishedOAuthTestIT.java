...
public class UnpublishedOAuthTestIT extends TestNGCitrusTestDesigner {
	...
	public void run() {
		...
		createVariable(ImportTestAction.API_CONFIG,  "/com/axway/apim/test/files/security/3_api-oauth.json");
