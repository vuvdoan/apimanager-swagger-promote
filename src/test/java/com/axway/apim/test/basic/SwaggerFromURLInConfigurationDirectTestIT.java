...
@Test(testName="SwaggerFromURLInConfigurationDirectTestIT")
public class SwaggerFromURLInConfigurationDirectTestIT extends TestNGCitrusTestDesigner {
	
	@Autowired
	private ImportTestAction swaggerImport;
	
	@CitrusTest(name = "SwaggerFromURLInConfigurationDirectTestIT")
	public void run() {
